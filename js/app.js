...
const MOVIES = [
  ...
  { e:"🧙‍♂🚪👹", a:["monsters inc","monsters sa","monsters, inc","monsters inc.","monsters" ,"monsters and co","monsters y company"] },
  { e:"🦸‍♂👨‍👩‍👧‍👦💥", a:["los increibles","the incredibles","increibles"] },
  { e:"🧅👹👸", a:["shrek"] },
  ...
  { e:"🐉🛩🏔", a:["como entrenar a tu dragon","how to train your dragon","entrenar a tu dragon"] },
  { e:"🐭👨‍🍳🥖", a:["ratatouille","ratatuie","ratatui"] },
  { e:"🧙‍♀🚂🎐", a:["el viaje de chihiro","spirited away","viaje de chihiro"] },
  { e:"🏎⚡🏁", a:["cars","cars 1"] },
  { e:"🐼🥋🐉", a:["kung fu panda","kungfu panda"] },
  { e:"🌊🚢🗿", a:["moana","vaiana"] },
  { e:"🧒🧓🪗🌺", a:["coco"] },
  { e:"🦊👮‍♂🕵‍♀", a:["zootopia","zootropolis"] },
  { e:"🧜‍♀🌊🐚", a:["la sirenita","the little mermaid","sirenita"] },
...
function skip(){
  feedback.innerHTML = <span class=\"small\">⏭ Saltaste. Era: <strong>${pool[currentIndex].a[0]}</strong></span>;
  btnNext.style.display = 'inline-block';
  btnCheck.disabled = true;
  vibrate(15);
}
